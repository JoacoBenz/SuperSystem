...
export const salesPermissions: PermissionDefinition[] = [
  ...
  { resource: 'invoice', action: 'read', description: 'View customer (AR) invoices' },
  { resource: 'invoice', action: 'manage', description: 'Create, issue and collect AR invoices' },
...
export const salesRoles: RoleDefinition[] = [
  {
    ...
    permissions: ['sales.customer.read', 'sales.customer.manage', 'sales.order.read', 'sales.order.manage', 'sales.invoice.read', 'sales.invoice.manage', 'sales.dashboard.read'],
  },
  {
    name: 'sales.rep',
    displayName: 'Sales Representative',
    permissions: ['sales.customer.read', 'sales.order.read', 'sales.order.manage', 'sales.invoice.read', 'sales.invoice.manage', 'sales.dashboard.read'],
  },
  {
    name: 'sales.viewer',
    displayName: 'Sales Viewer',
    permissions: ['sales.customer.read', 'sales.order.read', 'sales.invoice.read', 'sales.dashboard.read'],
  },
];
